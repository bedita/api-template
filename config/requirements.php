...
if (!extension_loaded('intl')) {
    trigger_error('You must enable the intl extension to use BEdita.' . PHP_EOL, E_USER_ERROR);
}
...
if (!extension_loaded('mbstring')) {
    trigger_error('You must enable the mbstring extension to use BEdita.' . PHP_EOL, E_USER_ERROR);
}
